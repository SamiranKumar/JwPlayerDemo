...
public class WidevineCallback implements MediaDrmCallback {
    ...
    public WidevineCallback(String drmAuthUrl, String drmKey) {

        //String params = "?pallycon-customdata-v2=" + drmKey;
        String params1 = "?video_id=2152330317768322"  + "&provider=pallycon" ;


        defaultUri = drmAuthUrl + params1;
    }
